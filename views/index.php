...
<head>
  <meta charset="UTF-8">
  <title>CodePen - Beautiful Dashboard UI</title>
  <meta charset="UTF-8">
...
<div class="dash">
  ...
  <!-- HEADER -->
  <header class="header">
    <h1 class="header__heading"><a href="" target="_blank" rel="noreferrer noopener">DI</a></h1>
    ...
    <div class="header__options">
      ...
      <a href="./login.php" class="header__link">Log in</a>
      <a href="./signup.php" class="header__link">Sign up</a>
    </div>
  </header>
